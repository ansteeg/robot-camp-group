...
a manifesto about how stationery is the bedrock of civilization. Margaret squared her shoulders,
Harold glared, Greg clapped once—slowly—the intern choked back a cough, and the janitor inspected
the ceiling for croissant shrapnel."""
    return act1
...
def act2_sophie():
 ...
 with a jab of her pen, causing an unfortunate explosion of glitter over the meeting notes. Harold muttered 
 about cleanup, Greg folded his arms, Margaret pointed with her pen, the intern chased the glitter, and the
 janitor opened a window."""
    return act2
