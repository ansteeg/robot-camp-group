...
def act1_scene4():
    print("The Robaddies, featuring Don Quijote, Princess Dia, Din Jin Ping, Dracula, and Don Tour, are at luck! Their group also consists of a doctor, Doctor Nikki. Doctor Nikki is a plastic surgeon that really enjoys working on using plastic from the streets and putting it into people.")
